...
<link href="{{ asset('vendor/media/css/media.css?v=' . time()) }}" rel="stylesheet" type="text/css" />
<script src="{{ asset('vendor/media/js/integrate.js?v=' . time()) }}"></script>

<script src="{{ url('vendor/media/packages/jquery-context-menu/jquery.ui.position.min.js') }}"></script>
<script src="{{ url('vendor/media/packages/jquery-context-menu/jquery.contextMenu.min.js') }}"></script>