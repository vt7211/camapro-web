...
<div class="tabcontent" data-tab="account">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 text-center tabchild" id="dklamcoso" style="padding-top: 50px;">
                <div style="width: 70%; margin: 0px auto;">
                    <img src="/images/logo-md.png" alt="logo" class="mb-20px" style="">
            ...
            <div class="col-md-12 text-center accountnotlogin tabchild active" id="accountnotlogin" style="padding-top: 50px;">
                <div style="width: 70%; margin: 0px auto;">
                    <img src="/images/logo-md.png" alt="logo" class="mb-20px" style="">
                    <div class="ndmain gr active" id="grlogin">
                        ...
                        <p><a href="#" class="change_gr" data-gr="grdktv">Đăng ký thành viên</a></p>
                        <p><a href="#" class="change_gr" data-gr="grforget">Quên mật khẩu</a></p>
                        <p><a href="#" class="change_gr red" data-gr="grdkcs">Đăng ký làm cơ sở Camapro</a></p>
                    </div>
                    <div class="ndmain gr" id="grdktv">
                        ...
                        <p><a href="#" class="change_gr" data-gr="grlogin">Đăng nhập</a></p>
                        <p><a href="#" class="change_gr" data-gr="grforget">Quên mật khẩu</a></p>
                        <p><a href="#" class="change_gr red" data-gr="grdkcs">Đăng ký làm cơ sở Camapro</a></p>
                    </div>
                    <div class="ndmain gr " id="grotp">
                        ...
                        <div class="input-group mb-15px">
                            ...
                            <a href="#" class="input-group-addon action" data-nameaction="resentcode"><i class="fa fa-send"></i></a>
                        </div>
