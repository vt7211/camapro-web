...
@endsection()
@section("breadcrumb")
<h1 class="main-title float-left">Sửa {{$nametype}}</h1>
...
@endsection()
@section("content")
<form autocomplete="off" method="post" action="{{ URL::Route('admin.news.postEdit',array($type,$id)) }}" enctype="multipart/form-data" class="row">
 <div class="col-sm-8">
    <div class="card mb-3">
       <div class="card-body">
            ...
            <div class="form-group">
                <input id="name" class="form-control" data-parsley-trigger="change" autocomplete="off" type="text" value="{{ $data['name'] }}" name="name" required="" placeholder="Tên {{$nametype}}">
            </div>
            <div class="form-group">
                <div class="input-group">
                    <input id="generalalias" class="form-control" value="{{ $Alias->alias }}" name="alias" required="" type="text">
    ...
    <div class="card mb-3">
       ...
       <div class="card-body">
            <div class="form-group">
              <textarea  class="form-control wys" name="intro" id="note" cols="30" rows="5" placeholder="Mô tả ngắn cho {{$nametype}}">{{ $data['intro'] }}</textarea>
            </div>
        </div>
    </div>
    <div class="card mb-3">
 ...
 <div class="col-sm-4">
    ...
    <div class="card mb-3">
        <div class="card-header"><b>Nhóm {{$nametype}}</b></div>
       <div class="card-body">
            <?php $cat = array();
            ...
            ?>
            <div class="wpchoosecate"><?php choose_cate($parent,$cat); ?></div>

        </div>
    </div>
    <div class="card mb-3">
        <div class="card-header"><b>Ảnh Đại Diện ( Tối đa: 400kb)</b></div>
        <div class="card-body">
            <img class="mb-2" id="imgthumb" src="{{ $data['image']!='' ? get_image_url($data['image'],'featured'): URL('/images/no-image.jpg') }}" alt="thumbnail">
