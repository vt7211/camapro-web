...
@endsection()
@section("breadcrumb")
<h1 class="main-title float-left">Thêm Trang</h1>
...
@endsection()
@section("content")
<form autocomplete="off" method="post" action="{{ URL::Route('admin.page.postadd') }}" enctype="multipart/form-data" class="row">
 <div class="col-sm-8">
    <div class="card mb-3">
       <div class="card-body">
            ...
            <div class="form-group">
                <input id="name" class="form-control" data-parsley-trigger="change" autocomplete="off" type="text" value="" name="name" required="" placeholder="Tiêu đề trang">
            </div>
            <div class="form-group">
                <div class="input-group">
                    <input id="alias" class="form-control" id="alias" placeholder="Đường dẫn" value="" name="alias" required="" type="text">
