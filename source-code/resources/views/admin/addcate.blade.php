...
@section("title","Thêm nhóm ".$namecat)
@section("css")
<style>
...
@endsection()
@section("breadcrumb")
<h1 class="main-title float-left">Thêm Nhóm {{$namecat}}</h1>
...
@endsection()
@section("content")
<form autocomplete="off" method="post" action="{{ URL::Route('admin.cate.postAdd',$type) }}" enctype="multipart/form-data" class="row">
 <div class="col-sm-12">
    <div class="card mb-3">
        <div class="card-header">
            <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-save"></i> Lưu</button>
          <a href="#" onclick="goBack()" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Bỏ Qua</a>
       </div>
       <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control" id="order" data-parsley-trigger="change" autocomplete="off" type="number" min="0" value="0" name="order" required="">
                </div>
                <div class="form-group col-md-3">
                    <label for="keywords">Từ Khóa SEO</label>
                    <input class="form-control" id="keywords" data-parsley-trigger="change" autocomplete="off" type="text" value="" name="keywords" >
                </div>
                <div class="form-group col-md-3">
                    <label for="description">Mô Tả SEO</label>
                    <input class="form-control" id="description" data-parsley-trigger="change" autocomplete="off" type="text" value="" name="description">
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <img style="max-height:150px" id="imgthumb" src="{{ URL('/images/no-image.jpg') }}" alt="thumbnail">
                    <a href="#" class="choose_thumb btn btn-primary" data-inputid="feature_image"><i class="fa fa-upload"></i> Chọn Ảnh</a>
                </div>
                <div class="form-group col-md-12">
                    <label for="alias">Mô Tả Ngắn</label>
...
if (jQuery().rvMedia) {
    $('.choose_thumb').rvMedia({
        ...
        onSelectFiles: function (files, $el) {
            ...
            $('#feature_image').val(firstItem.thumb);
